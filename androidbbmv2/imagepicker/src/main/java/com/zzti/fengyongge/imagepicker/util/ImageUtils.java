...
public class ImageUtils {
    ...
    public static Bitmap getimage(String srcPath) {
        ...
        int oldW = newOpts.outWidth;
        int oldH = newOpts.outHeight;
        //现在主流手机比较多是800*480分辨率，所以高和宽我们设置为
//        int newH = 1280;//这里设置高度为800f
//        int newW = 720;//这里设置宽度为480f
         int newH = 1920;//这里设置高度为800f
        int newW = 1080;//这里设置宽度为480f
        ...
        try {
           ...
           int options = 100;
            while ( baos.toByteArray().length / 1024>1024 && options>0) {  //循环判断如果压缩后图片是否大于100kb,大于继续压缩
                ...
                image.compress(Bitmap.CompressFormat.JPEG, 90, baos);//这里压缩options%，把压缩后的数据存放到baos中
                options -= 10;//每次都减少10
            }
