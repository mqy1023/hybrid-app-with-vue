...
import com.zzti.fengyongge.imagepicker.util.OSUtils;
...
import androidtest.example.com.utils.WhiteProgressDialog;
...
public class PhotoSelectorActivity extends Activity implements SelectPhotoItem.onItemClickListener, SelectPhotoItem.onPhotoItemCheckedListener,
    ...
    private int limit;
    private androidtest.example.com.utils.WhiteProgressDialog mDialog;
...
//        requestWindowFeature(R.style.AppTheme1);
    ...
    private void ok() {
        if (selected.isEmpty()) {
            ...
            if (mDialog == null) {
                mDialog = new WhiteProgressDialog(this, R.style.loading_dialog);
