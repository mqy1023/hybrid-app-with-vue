...
import itemOperationGold from '@components/item-operation-gold'
import { USER_TRANSFER_GOLDLIST } from '@api/user'
...
export default {
  ...
  methods: {
    ...
    getHots () {
      ...
      this.$reqPost(USER_TRANSFER_GOLDLIST, { ...params, sign: this.$getJsaParam(params) }).then(res => {
