<template>
  <div class="login-content">
    ...
    <div class="login-big-title">设置密码</div>
    ...
    <button-xbd :disabled="isDisabledStart" @click="onClickLogin">确认</button-xbd>
  </div>
</template>
...
export default {
  ...
  computed: { // 监听子组件的disabled用于启用或禁用按钮
    isDisabledStart () {
      if (this.phone && this.phone.length === 11 && this.pwd && this.pwd.length > 5 && this.code && this.code.length === 6) {
